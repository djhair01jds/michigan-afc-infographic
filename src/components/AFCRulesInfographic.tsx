  ...
  const detailedChanges = {
    ...
    small: [
      ...
      },
      {
        ...
        impact: "medium",
        visual: { old: "🌡️ Temps + Sanitation", new: "🏷️ Label + Date + Allergen + Staff Qualification" },
        timeline: "Immediate",
        cost: "$0 (labels)",
        action: "Implement labeling/discard dating for repackaged perishables; add allergen labeling; document qualified food-prep staff; continue temperature + sanitation controls",
        source: "LARA Key Highlight #11"
      },
      // BENEFICIAL
      {
    ...
    large: [
      ...
      },
      {
        ...
        newText: "Prior controls continue; adds explicit repackaged-food labeling + discard dating (≤7 days; day 1 = open/prep); allergen indication required when applicable; qualified food-prep staffing documentation required (7+ residents)",
        impact: "medium",
        visual: { old: "🌡️ Temps + Sanitation", new: "🏷️ Label + Date + Allergen + Staff Qualification" },
        timeline: "Immediate",
        cost: "$0 (labels)",
        action: "Implement labeling/discard dating for repackaged perishables + allergen indication; confirm thermometers installed; document at least one qualified food-prep staff person",
        source: "LARA Key Highlight #11"
      },
      {
        id: 'large-ratios',
    ...
    congregate: [
      ...
      },
      {
        ...
        newText: "Detailed operational controls: 40°F/140°F holding temps, thermometers, equipment/utensils cleaned + air dried; adds repackaged-food labeling + discard dating (≤7 days; day 1 = open/prep); allergen indication required; qualified food-prep staffing documentation required",
        impact: "medium",
        visual: { old: "🌡️ General Safety Controls", new: "🏷️ Label + Date + Temp + Allergen" },
        timeline: "Immediate",
        cost: "$0 (labels)",
        action: "Implement repackaged perishable labeling + discard dating + allergen indication; ensure thermometers installed; clean + air dry utensils/equipment after each use; maintain qualified food-prep staff documentation",
        source: "LARA Key Highlight #11"
      },
      {
