  ...
  const detailedChanges = {
    family: [
      ...
      },
      {
        ...
        oldRule: "R 400.1419 (legacy); Special diets shall be prescribed only by a physician.",
        oldRuleUrl: "/family_home_rules.pdf",
        newRule: "R 400.663",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        oldText: "3 meals/day, ≤14 hours between evening and morning meal; menus required only upon departmental direction; older USDA/RDA-era nutrition references; special diets prescribed by physician only",
        ...
        impact: "medium",
        visual: { old: "🍽️ RDA-era + Physician-Only Diets", new: "📋 DGA 2020-2025 + Weekly Menus" },
        timeline: "Immediate",
        cost: "$0",
        action: "Update nutrition policy to DGA 2020–2025; implement weekly menu planning + posting + substitution documentation; keep menus 90 days; update special diet prescribing from physician-only to any appropriately licensed health care professional",
    ...
    small: [
      ...
      },
      {
        ...
        icon: ClipboardList,
        title: "Updated Nutrition Standards",
        oldRule: "R 400.14313 (legacy); Special diets shall be prescribed only by a physician.",
        oldRuleUrl: "/small_group_home_rules.pdf",
        newRule: "R 400.663",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        ...
        impact: "medium",
        visual: { old: "📋 RDA + 1-Year Records + Physician-Only", new: "📋 DGA 2020-2025 + 90-Day Records" },
        timeline: "Immediate",
        cost: "$0",
        action: "Align menus to DGA 2020–2025; reduce menu retention to 90 days; update special diet workflow from physician-only to accept orders from any appropriately licensed health care professional",
        source: "LARA Key Highlight #11"
      },
      {
    ...
    large: [
      ...
      },
      {
        ...
        icon: ClipboardList,
        title: "Updated Nutrition Standards",
        oldRule: "R 400.15313 (legacy); Special diets shall be prescribed only by a physician.",
        oldRuleUrl: "/large_group_home_rules.pdf",
        newRule: "R 400.663",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        ...
        timeline: "Immediate",
        cost: "$0",
        action: "Align menus to DGA 2020–2025; reduce menu retention to 90 days; update special diet workflow from physician-only to broader health care professional prescribing",
        source: "LARA Key Highlight #11"
      },
      {
    ...
    congregate: [
      ...
      },
      {
        ...
        icon: ClipboardList,
        title: "Updated Nutrition Standards",
        oldRule: "R 400.2471, R 400.2474 (legacy); Special diets shall be prescribed only by a physician.",
        oldRuleUrl: "/congregate_rules.pdf",
        newRule: "R 400.663",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        oldText: "3 meals/day; ≤15 hours between evening and morning meal; menus 3 days in advance; no explicit 90-day retention; older nutrition references; special diets prescribed by physician only",
        ...
        impact: "medium",
        visual: { old: "🍽️ 15hrs + 3-Day Menus + Physician-Only", new: "📋 DGA + 14hrs + Weekly Menus + 90-Day Records" },
        timeline: "Immediate",
        cost: "$0",
        action: "Update meal timing to ≤14 hours; shift to weekly (1-week ahead) menu planning + posting + substitution documentation; retain menus 90 days; align to DGA 2020–2025; update special diet workflow from physician-only to any appropriately licensed health care professional",
        source: "LARA Key Highlight #11"
      },
      {
