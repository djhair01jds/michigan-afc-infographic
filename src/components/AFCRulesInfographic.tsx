  ...
  const detailedChanges = {
    family: [
      // HIGH IMPACT (sorted by rule number)
      {
        ...
        oldRuleUrl: "https://web.archive.org/web/20240519171526/https://www.michigan.gov/-/media/Project/Websites/lara/bchs/ocal/Folder1/lara_BCAL_PUB-332.pdf",
        newRule: "R 400.627(2)",
      ...
      {
        id: 'family-food-labeling',
        icon: Tag,
        title: "Food Labeling Requirements",
        oldRule: "General food safety",
        oldRuleUrl: "https://web.archive.org/web/20240519171526/https://www.michigan.gov/-/media/Project/Websites/lara/bchs/ocal/Folder1/lara_BCAL_PUB-332.pdf",
        newRule: "R 400.665(7)",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        oldText: "Food storage followed general safety practices",
        newText: "Food removed from original packaging must be labeled with prepared/opened date and discard date; discard date maximum 7 days for perishables; day of opening/preparation counts as day 1",
        impact: "medium",
        visual: { old: "📦 Unlabeled", new: "🏷️ Date + Discard (7 days max)" },
        timeline: "Immediate",
        cost: "$0 (labels)",
        action: "Implement food labeling system; train staff on 7-day discard rule for perishables",
    ...
    small: [
      // HIGH IMPACT
      {
        ...
        title: "AFC New Provider Training Required",
        oldRule: "No equivalent",
        oldRuleUrl: "https://web.archive.org/web/20240331161854/https://www.michigan.gov/-/media/Project/Websites/lara/bchs/ocal/Folder1/lara_BCAL_PUB-333_Small_Grp_Homes.pdf",
        newRule: "R 400.627(2)",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        oldText: "No mandatory new provider training requirement",
        newText: "All licensees and administrators must complete AFC New Provider Training within 6 months of license issuance or hire; once completed, doesn't need repeating if documentation exists",
      ...
      },
      {
        ...
        oldRuleUrl: "https://web.archive.org/web/20240519171526/https://www.michigan.gov/-/media/Project/Websites/lara/bchs/Folder1/Fire%20Safety%20Rules.pdf",
        newRule: "R 400.727(7)",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
    ...
    large: [
      // HIGH IMPACT
      {
        ...
        title: "AFC New Provider Training Required",
        oldRule: "No equivalent",
        oldRuleUrl: "https://michigan.adultfostercare.net/large_group_home_rules.pdf",
        newRule: "R 400.627(2)",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        oldText: "No mandatory new provider training requirement",
        newText: "All licensees and administrators must complete AFC New Provider Training within 6 months of license issuance or hire; once completed, doesn't need repeating if documentation exists",
    ...
    congregate: [
      // HIGH IMPACT
      {
        ...
        title: "AFC New Provider Training Required",
        oldRule: "No equivalent",
        oldRuleUrl: "https://michigan.adultfostercare.net/congregate_rules.pdf",
        newRule: "R 400.627(2)",
        newRuleUrl: "https://www.michigan.gov/lara/-/media/Project/Websites/lara/bchs/Folder1/AFC-Ruleset-Final.pdf",
        oldText: "No mandatory new provider training requirement",
        newText: "All licensees and administrators must complete AFC New Provider Training within 6 months of license issuance or hire; once completed, doesn't need repeating if documentation exists",
